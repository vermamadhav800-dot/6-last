      ...
      >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
          ...
          <StatCard
            ...
            value={`${occupancyRate}%`}
            subtitle={`${occupiedRoomsCount}/${totalRooms} rooms`}
            icon={DoorOpen}
            trend="up"
            trendValue="+5%"
            color="green"
                ...
                {recentActivity.length > 0 ? (
                  recentActivity.map((activity) => (
                    <div key={activity.id} className="flex items-center space-x-2 md:space-x-3 p-2 md:p-3 rounded-lg bg-slate-50 dark:bg-slate-800">
                      <div className={`p-1.5 md:p-2 rounded-full bg-${activity.color}-100 dark:bg-${activity.color}-900/30 flex-shrink-0`}>
                        <activity.icon className={`w-3 h-3 md:w-4 md:h-4 text-${activity.color}-600 dark:text-${activity.color}-400`} />
                      </div>
                      <div className="flex-1 min-w-0">
                  ...
                  <div className="text-center py-6 md:py-8 text-slate-500 dark:text-slate-400">
                    <Activity className="w-8 h-8 md:w-12 md:h-12 mx-auto mb-3 md:mb-4 opacity-50" />
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-3 md:space-y-4">
                  ...
                  <div className="flex items-center space-x-2 md:space-x-3 p-2 md:p-3 rounded-lg bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="text-xs md:text-sm text-red-700 dark:text-red-300">
                        {overduePayments.length} tenant(s) have overdue payments
                      </p>
                    </div>
                  </div>
                )}
                
                <div className="flex items-center space-x-2 md:space-x-3 p-2 md:p-3 rounded-lg bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800">
                  <Info className="w-4 h-4 md:w-5 md:h-5 text-blue-500 flex-shrink-0" />
                  <div className="min-w-0 flex-1">
                    <p className="font-medium text-blue-900 dark:text-blue-100 text-sm md:text-base">System Update</p>
                ...
                <div className="flex items-center space-x-2 md:space-x-3 p-2 md:p-3 rounded-lg bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800">
                  <CheckCircle className="w-4 h-4 md:w-5 md:h-5 text-green-500 flex-shrink-0" />
                  <div className="min-w-0 flex-1">
                    <p className="font-medium text-green-900 dark:text-green-100 text-sm md:text-base">All Systems Operational</p>
