            ...
            {updateRequests.map(request => {
                ...
                return (
                    <Card key={request.id} className="glass-card">
                        ...
                        <CardContent className="space-y-4">
                           <p className="text-sm text-muted-foreground">Submitted: {request?.submittedAt ? format(new Date(request.submittedAt), 'dd MMM, yyyy') : 'N/A'}</p>
                    ...
                    <Card key={request.id} className="glass-card">
                        ...
                        <CardContent className="space-y-4">
                            ...
                            <div>
                                ...
                                <p className="font-medium">{request?.submittedAt ? format(new Date(request.submittedAt), 'dd MMM, yyyy - hh:mm a') : 'N/A'}</p>
                            </div>
                        </CardContent>
